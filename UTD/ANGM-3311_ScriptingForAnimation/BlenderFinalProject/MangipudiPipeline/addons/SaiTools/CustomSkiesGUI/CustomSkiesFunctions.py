...
def apply_color_config(rgb_shader_node, mix_shader_node, color_config):
    ...
    rgb_shader_node.outputs[0].default_value = (
        color_value[0], 
        color_value[1], 
        color_value[2], 
        1.0
...
def create_sun_config(sun_rotation, sun_intensity, sun_elevation, altitude, air_density, dust_density, ozone_density, sun_size):
    '''Creates a sun configuration'''
    sun_config = {
        ...
        "sun_size": math.radians(sun_size)
    }
    return sun_config

def create_color_config(sky_color, mix_factor):
...
def create_cloud_config(cloud_size, cloud_vector, cloud_opacity, cloud_intensity, cloud_color):
    '''Creates a cloud configuration'''
    cloud_config = {
        "cloud_size": cloud_size,
        "cloud_vector": cloud_vector,
...
def execute_random_configurations():
    '''Executes random configurations for the sky'''
